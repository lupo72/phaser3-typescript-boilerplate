class GameScene extends Phaser.Scene {
    ...
    preload() {
        this.load.spritesheet('MyBasicTileset', './assets/tilesets/MyBasicTileset.png', {frameWidth:32, frameHeight:32});
        this.load.tilemapTiledJSON('MyTilemap', './assets/tilemaps/demo-level-01.json');
    }
    ...
    create() {
        ...
        this.player = new Player({scene: this, x: 10, y: 440}, 'Player');
